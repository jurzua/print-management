...
class ServiceNotifier extends Thread {
	...
	/*
	 * A heuristic is used to calculate sleep time. 10 times the time taken to
	 * loop through all the listeners, with a minimum of 15 seconds. Ensures
	 * this won't take more than 10% of available time.
	 */
	public void run() {
		/*
